...
export const GAMES: GameDef[] = [dustyard, squadfall, facingTowers, riftYard, skyObby, voxelIsland, castleRun, goldRunner, wolfden, cinemaCarnage, chompMaze, disasterIsland, blobKart, battleChess, starter]
